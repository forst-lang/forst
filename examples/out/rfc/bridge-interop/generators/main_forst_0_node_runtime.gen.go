...
var forstBridgeManifestJSON string = "{\"version\":1,\"exports\":[{\"moduleId\":\"legacy/generators.ts\",\"name\":\"asyncNumbers\",\"kind\":\"asyncGenerator\"},{\"moduleId\":\"legacy/generators.ts\",\"name\":\"emptyGen\",\"kind\":\"generator\"},{\"moduleId\":\"legacy/generators.ts\",\"name\":\"finallyRunCount\",\"kind\":\"function\"},{\"moduleId\":\"legacy/generators.ts\",\"name\":\"resetFinallyCount\",\"kind\":\"function\"},{\"moduleId\":\"legacy/generators.ts\",\"name\":\"returnGen\",\"kind\":\"generator\"},{\"moduleId\":\"legacy/generators.ts\",\"name\":\"syncNumbers\",\"kind\":\"generator\"},{\"moduleId\":\"legacy/generators.ts\",\"name\":\"throwGen\",\"kind\":\"generator\"},{\"moduleId\":\"legacy/generators.ts\",\"name\":\"withFinally\",\"kind\":\"generator\"}]}"
...
func forst_node_open_seq_legacy_generators_ts_asyncNumbers() (*forstNodeSeq_float64, error) {
	var seq, err = bridgert.OpenSeqArgs[float64]("legacy/generators.ts", "asyncNumbers", bridgert.ExportKindAsyncGenerator, json.RawMessage("[3]"))
	if err != nil {
		return nil, err
	}
...
func forst_node_open_seq_legacy_generators_ts_emptyGen() (*forstNodeSeq_float64, error) {
	var seq, err = bridgert.OpenSeqArgs[float64]("legacy/generators.ts", "emptyGen", bridgert.ExportKindGenerator, json.RawMessage("[]"))
	if err != nil {
		return nil, err
	}
	return &forstNodeSeq_float64{inner: seq}, nil
...
func forst_node_open_seq_legacy_generators_ts_withFinally() (*forstNodeSeq_float64, error) {
	var seq, err = bridgert.OpenSeqArgs[float64]("legacy/generators.ts", "withFinally", bridgert.ExportKindGenerator, json.RawMessage("[]"))
	if err != nil {
		return nil, err
	}
	return &forstNodeSeq_float64{inner: seq}, nil
