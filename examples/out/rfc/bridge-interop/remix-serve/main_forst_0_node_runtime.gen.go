...
var forstBridgeManifestJSON string = "{\"version\":1,\"exports\":[{\"moduleId\":\"legacy/activity.ts\",\"name\":\"activityFeed\",\"kind\":\"asyncGenerator\"},{\"moduleId\":\"legacy/activity.ts\",\"name\":\"dispatchActivity\",\"kind\":\"asyncFunction\"},{\"moduleId\":\"legacy/activity.ts\",\"name\":\"recentTitles\",\"kind\":\"generator\"},{\"moduleId\":\"legacy/todos.ts\",\"name\":\"addTodo\",\"kind\":\"function\"},{\"moduleId\":\"legacy/todos.ts\",\"name\":\"allTodos\",\"kind\":\"generator\"},{\"moduleId\":\"legacy/todos.ts\",\"name\":\"bumpEditCount\",\"kind\":\"function\"},{\"moduleId\":\"legacy/todos.ts\",\"name\":\"formatTodoList\",\"kind\":\"function\"},{\"moduleId\":\"legacy/todos.ts\",\"name\":\"openCount\",\"kind\":\"function\"},{\"moduleId\":\"legacy/todos.ts\",\"name\":\"persistSnapshot\",\"kind\":\"asyncFunction\"},{\"moduleId\":\"legacy/todos.ts\",\"name\":\"todoCount\",\"kind\":\"function\"},{\"moduleId\":\"legacy/todos.ts\",\"name\":\"toggleTodo\",\"kind\":\"function\"}]}"
...
func forst_node_callasync_legacy_todos_ts_persistSnapshot() (T_8ycLsMp1YzS, error) {
	return bridgert.CallAsyncArgs[T_8ycLsMp1YzS]("legacy/todos.ts", "persistSnapshot", json.RawMessage("[]"))
}
func forst_node_callsync_legacy_todos_ts_addTodo(arg0 string) (T_KuaRmDfgFpc, error) {
	return bridgert.CallSync[T_KuaRmDfgFpc]("legacy/todos.ts", "addTodo", arg0)
}
func forst_node_callsync_legacy_todos_ts_bumpEditCount() (float64, error) {
	return bridgert.CallSyncArgs[float64]("legacy/todos.ts", "bumpEditCount", json.RawMessage("[]"))
}
func forst_node_callsync_legacy_todos_ts_formatTodoList() (string, error) {
	return bridgert.CallSyncArgs[string]("legacy/todos.ts", "formatTodoList", json.RawMessage("[]"))
}
func forst_node_callsync_legacy_todos_ts_openCount() (float64, error) {
	return bridgert.CallSyncArgs[float64]("legacy/todos.ts", "openCount", json.RawMessage("[]"))
}
func forst_node_callsync_legacy_todos_ts_todoCount() (float64, error) {
	return bridgert.CallSyncArgs[float64]("legacy/todos.ts", "todoCount", json.RawMessage("[]"))
}
func forst_node_callsync_legacy_todos_ts_toggleTodo(arg0 string) (T_KuaRmDfgFpc, error) {
	return bridgert.CallSync[T_KuaRmDfgFpc]("legacy/todos.ts", "toggleTodo", arg0)
}
func forst_node_open_seq_legacy_activity_ts_activityFeed() (*forstNodeSeq_t_lkhz7dyfnqt, error) {
	var seq, err = bridgert.OpenSeqArgs[T_LKhz7DyfNqT]("legacy/activity.ts", "activityFeed", bridgert.ExportKindAsyncGenerator, json.RawMessage("[\"demo\"]"))
	if err != nil {
		return nil, err
	}
...
func forst_node_open_seq_legacy_activity_ts_recentTitles() (*forstNodeSeq_string, error) {
	var seq, err = bridgert.OpenSeqArgs[string]("legacy/activity.ts", "recentTitles", bridgert.ExportKindGenerator, json.RawMessage("[3]"))
	if err != nil {
		return nil, err
	}
