...
func forst_node_callasync_legacy_payment_ts_concurrentEcho(arg0 float64) (T_NTbLJjyksQg, error) {
	return bridgert.CallAsync[T_NTbLJjyksQg]("legacy/payment.ts", "concurrentEcho", arg0)
}
func forst_node_callasync_legacy_payment_ts_create(arg0 float64, arg1 string) (T_BSiWS9EsB18, error) {
	return bridgert.CallAsync[T_BSiWS9EsB18]("legacy/payment.ts", "create", arg0, arg1)
}
func forst_node_open_seq_legacy_events_ts_subscribe(arg0 string) (*forstNodeSeq_t_g2n6vmumv8n, error) {
	var seq, err = bridgert.OpenSeq[T_G2n6vMumV8n]("legacy/events.ts", "subscribe", bridgert.ExportKindAsyncGenerator, arg0)
	if err != nil {
		return nil, err
	}
