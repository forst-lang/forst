...
describe("forst-runtime-index CLI", () => {
  ...
  it("indexes payment.ts exports from the bridge-interop example", () => {
...
describe("payment fixture exists", () => {
  it("is present at examples/in/rfc/bridge-interop/legacy/payment.ts", async () => {
