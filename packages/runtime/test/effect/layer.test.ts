...
describe("ForstRuntimeLayer logging", () => {
  ...
  test("Effect.logDebug emits pretty output when FORST_BRIDGE_LOG_LEVEL=debug", async () => {
  ...
  test("FORST_BRIDGE_LOG_FORMAT=json emits structured JSON with span annotations", async () => {
    process.env[envLogLevel] = "debug";
    ...
    expect(payload.component).toBe("forst-runtime");
