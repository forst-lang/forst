...
| `@forst/cli` on npm and JSR (compiler / CLI) | 🔬 experimental | [`@forst/cli`](./packages/cli/README.md): npm package version tracks the compiler; lazy-download of the native `forst` from GitHub Releases; published on compiler tags ([release.yml](./.github/workflows/release.yml)). Short overview: [README — npm](./README.md#npm). Not the same package as sidecar. |
