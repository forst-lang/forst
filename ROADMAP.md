...
| `@forst/gen/testing` test scopes | ✅ done | `withForstTestScope` function / package / transport overrides without HTTP or module mocks (`generate.testingSubpath` escape hatch). |
