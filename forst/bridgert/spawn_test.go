...
func TestBuildHostSpawnCommand_autoRegisterAndAppReadyModule(t *testing.T) {
	...
	registerPath := filepath.Join(root, "node_modules", "@forst", "runtime", "dist", "host", "register.mjs")
	...
	wantRegister := filepath.Join(root, "node_modules", "@forst", "runtime", "dist", "host", "register.mjs")
	wantLoader := filepath.Join(root, "node_modules", "tsx", "dist", "loader.mjs")
