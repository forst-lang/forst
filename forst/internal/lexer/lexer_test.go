...
func TestLexer_UnsupportedTokens(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			input: "+= -= *= /= %= &= |=",
			expected: []ast.Token{
				{Type: ast.TokenPlusEq, Value: "+=", FileID: testFileID, Line: 1, Column: 1},
				{Type: ast.TokenMinusEq, Value: "-=", FileID: testFileID, Line: 1, Column: 4},
				{Type: ast.TokenStarEq, Value: "*=", FileID: testFileID, Line: 1, Column: 7},
				{Type: ast.TokenDivideEq, Value: "/=", FileID: testFileID, Line: 1, Column: 10},
				{Type: ast.TokenModuloEq, Value: "%=", FileID: testFileID, Line: 1, Column: 13},
				{Type: ast.TokenBitwiseAndEq, Value: "&=", FileID: testFileID, Line: 1, Column: 16},
				{Type: ast.TokenBitwiseOrEq, Value: "|=", FileID: testFileID, Line: 1, Column: 19},
				{Type: ast.TokenEOF, Value: "", FileID: testFileID, Line: 2, Column: 1},
			},
		},
		{
