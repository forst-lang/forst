...
Built-in constraints cover strings, integers, and presence. **Type guards** let you define **domain-specific predicates** that work with **`ensure`** and narrow types, without type assertions or branded-type hacks.
