...
| JS / npm ecosystem | Native | No | [Call legacy JS/TS](/interop/node/call-javascript) via `import "./path" node` |
...
<Info>
  Go import loading, Node interop, Providers, generate plugins, and several invoke paths are **experimental**. See the [roadmap](/resources/roadmap) for current status.
</Info>
