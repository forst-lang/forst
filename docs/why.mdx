...
| Structural record types | Built-in | Structs | [Built-in](/language/overview) |
...
<CardGroup cols={2}>
  <Card title="Structural types on the server" icon="table-columns" href="/language/overview">
