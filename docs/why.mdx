...
- **Node:** Stay type-aligned with the frontend and migrate route by route without a big bang rewrite. See [JS bridge interop](/interop/node).
...
| JS / npm ecosystem | Native | No | [Call legacy JS/TS](/interop/bridge/call-javascript) via `import "./path" node` |
