...
| <Icon icon="flask" iconType="solid" size={16} color="#7C3AED" /> | [Import and type-check Go packages](/interop/go) | `go/packages` loading and Forst↔Go call checking; common paths work, not full parity. |
| <Icon icon="flask" iconType="solid" size={16} color="#7C3AED" /> | Go FFI expressions (subslice, spread, fields) | `xs[1:3]`, `argv[1:]...`, `cmd.ProcessState.ExitCode()`; LSP hover/completion for stdlib imports. |
