---
title: "Introduction"
description: "Move TypeScript backends to Go with integrated client generation."
---

import CatalogOrder from "/snippets/catalog-order.mdx";

Forst is a programming language that helps you move TypeScript backends to Go with seamlessly integrated TypeScript clients.

Forst supports you in four key ways.
...
Type constraints validate incoming data automatically before it reaches your application logic. Constraints on the type replace manual checks at the boundary:
