...
flowchart LR
  ...
  ForstToJS -->|"import ./path node"| LegacyJS["legacy .ts / .js"]
```
...
- **Call legacy JavaScript from Forst** (`import "./path" node`, [`forst/nodert`](https://github.com/forst-lang/forst/tree/main/forst/nodert)) is experimental and may require Node in the deploy image. [Call JavaScript from Forst § Caveats](/interop/node/call-javascript#caveats)
