...
Repository example: [`examples/in/rfc/bridge-interop/multi-package-dev`](https://github.com/forst-lang/forst/tree/main/examples/in/rfc/bridge-interop/multi-package-dev).
...
Full combined demo: [`examples/in/rfc/bridge-interop/remix-serve`](https://github.com/forst-lang/forst/tree/main/examples/in/rfc/bridge-interop/remix-serve) (`task example:bridge-interop-remix-serve:e2e`).

Bridgert setup is covered in [Call JavaScript from Forst](/interop/bridge/call-javascript#host-mode-shared-memory).
